...
- Use `sdlc-urs-workflow` to define users, tasks, scenarios, and constraints.
- Use `sdlc-prd-workflow` to define product scope, features, user flows, and acceptance.
- Use `sdlc-nfr-spec` if business risk implies security, privacy, availability, performance, compliance, or reliability requirements.
- Use `sdlc-requirements-traceability` once downstream requirements and tasks exist.
