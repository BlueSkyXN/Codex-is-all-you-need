...
2. Decide artifact depth.
   ...
   - For Profile A, produce only a task-ready requirement brief.
   - For Profile B, produce PRD + SRS inputs.
   - For Profile C/D, produce or request BRD, URS, PRD, NFR, SRS, SPEC, RTM, and handoff as needed.
