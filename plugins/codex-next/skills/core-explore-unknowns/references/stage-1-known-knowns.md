...
Before saying anything about the code, walk the territory. Read the files the
task touches, gather what already exists (including half-built or reverted prior
attempts), the data shapes and conventions the code enforces, and anything that
smells load-bearing for the request.
