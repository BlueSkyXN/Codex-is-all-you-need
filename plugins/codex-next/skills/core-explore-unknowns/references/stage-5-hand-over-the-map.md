...
as one artifact the user keeps.
...
- **A build plan may accompany the map — never replace it.** Sort it by
  likelihood-of-tweaking, not execution order — judgment calls first with
  their alternatives toggleable, mechanical work collapsed at the bottom.
...
starts from it — offer to begin, and point the relevant implementation skill
at the map.
